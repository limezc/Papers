...
AIGC_TASK_TYPES = ["图像生成", "图像编辑", "视频生成", "视频编辑", "3D生成", "3D编辑", "多模态大语言模型", "其他多任务"]
AIGC_TASK_TYPES_ENGLISH = ["image generation", "image editing", "video generation", "video editing", "3D generation", "3D editing", "multimodal large language model", "other multi-task"]
...
analysis_engine = {
    "gpt": gpt_analyze_abstract,
    "moonshot": moonshot_analyze_abstract
}
